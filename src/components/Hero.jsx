        ...
        <div className="container">
          <div className="grid-container">
            <div className="featured grid-one">
              <Link to="/salam-enterprises-eccomerce-website/categories/furnitures">
            ...
            <div className="featured grid-two">
              <Link to="/salam-enterprises-eccomerce-website/categories/skin-care">
            ...
            <div className="featured grid-four">
              <Link to="/salam-enterprises-eccomerce-website/categories/kitchen">
            ...
            <div className="featured grid-four-low">
              <Link to="/salam-enterprises-eccomerce-website/categories/electronics">
